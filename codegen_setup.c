...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Mega Man Legends 2",
    .project_root_env = "MEGA_MAN_LEGENDS_2_PROJECT_ROOT",
    .build_dir_env = "MEGA_MAN_LEGENDS_2_BUILD_DIR",
    .force_setup_env = "MEGA_MAN_LEGENDS_2_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_035.56_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Mega_Man_Legends_2",
    .prepare_note =
